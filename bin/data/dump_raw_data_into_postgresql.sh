...
--py-files dist/streaming_pipeline.zip src/ssp/spark/streaming/consumer/twiteer_stream_consumer_main.py --run_id=0 --mode=dump_into_postgresql --num_records=35000
