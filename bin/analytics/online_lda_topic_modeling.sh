...
--packages org.apache.spark:spark-sql-kafka-0-10_2.11:2.4.4,org.apache.kafka:kafka-clients:2.4.0,io.delta:delta-core_2.11:0.4.0,com.johnsnowlabs.nlp:spark-nlp_2.11:2.4.5  \
--py-files dist/streaming_pipeline.zip src/ssp/spark/streaming/lda/lda_model_ope_main.py --mode=online_lad_model_predict